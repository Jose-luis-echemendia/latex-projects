...
\subsection{Componentes funcionales y esenciales del sistema}
...
\begin{longtable}{|p{0.8cm}|p{4cm}|p{5.2cm}|p{2cm}|p{2cm}|}
    ...
    % Cuerpo de la tabla
    \ac{RF}\#1 & Autenticar usuario & Permite acceder al sistema introduciendo los siguientes datos: & Alta & Baja \\ 
    \hline
    \rowcolor[HTML]{EDEBF1}
    \ac{RF}\#2 & Cerrar sesión & Permite cerrar la sesión de un usuario anteriormente autenticado & Baja & Baja \\  
    \hline
    \ac{RF}\#3 & Registrar usuario & Permite registrar un usuario en el sistema con los siguientes datos: & Alta & Baja \\ 
    \hline
