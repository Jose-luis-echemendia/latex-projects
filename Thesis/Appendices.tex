...
\begin{addendum}
	...
	\label{anx:hu}
		...
		\subsubsection*{Épica 3: Ciclo de Vida del Modelo de características (FM)}
		...
		\begin{userstory}[]
			...
			\storypoints{0.8}
			\storyprogrammer{Jose Luis Echemendia López}
			\storydescription{El diseñador y el observador deben poder obtener estadísticas y exportar el modelo en múltiples formatos, como \ac{UVL}, XML y \ac{JSON}, para compartirlo con otras herramientas o analizar su complejidad.}
			\storyacceptancecriteria{
			\begin{itemize}
	...
	\begin{crccard}[tb:crc_fmlogicalvalidator]
		...
		{
			\begin{itemize}
			\item Ejecutar validación SAT/SMT (sympy/pysat/z3).
