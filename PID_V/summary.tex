...
development sienta las bases técnicas para una nueva generación de herramientas de
...
Software, Variabilidad, Motor de Reglas, Plan de Estudios.
}
% RESUMEN EN INGLÉS
{
...
\textbf{Keywords:} Feature Models, Software Product Lines, Variability, Rule Engine, Curriculum.
}
