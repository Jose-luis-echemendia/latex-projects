\epigraph{herramientas y tecnologías}{
    ...
    \subepigraph{Algoritmos, Motor de Reglas y Validación}{
        ...
        simbólica, manteniendo precisión y trazabilidad en los análisis.
        ...
        componentes fuertemente conexas. Este enfoque orientado a grafos habilita la
        ...
        ante configuraciones incompletas o conflictivas. Esta hibridación permite un
    ...
    \subepigraph{Gestor de dependencias}{
        ...
        \textbf{UV} como gestores complementarios.
        ...
        instalación ultrarrápida de dependencias y creación de entornos. UV destaca
        ...
        escalabilidad y automatización del sistema.
    ...
    \subepigraph{Herramienta para el control de versiones}{
        ...
        avanzadas que proporcionan más personalización y control. Los conocidos servicios de 
    ...
    \subepigraph{Lenguaje de modelados}{
        ...
        El lenguaje de modelado a utilizar es el Lenguaje de Modelado Unificado (UML), 
    ...
    \subepigraph{Herramienta CASE}{
        ...
        términos de tiempo y de dinero \ciptep{pressman2014se}. Según Sommerville, estas herramientas nos pueden ayudar 
        ...
        Unificado (UML), la notación de Modelado de Procesos de Negocio (BPMN) y un 
        sinfín de diagramas.  Por lo que Visual Paradigm es una herramienta CASE 
